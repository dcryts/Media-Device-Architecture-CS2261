...
PRODUCT_NAME       = cs2261
SOURCES            = main.c myLib.c text.c space1.c gameSprites.c backSpace.c frontSpace.c laser.c midHorizons.c startHorizons.c

# --- System Settings (Update these for your system)
# DKPATH should contain arm-none-eabi-gcc{.exe}
# CCPATH should contain gcc{.exe}
# VBASIM should point to your VBA executable (or open on mac)
DKPATH             = /Users/DCryts/Desktop/2261/devkitARM/bin
CCPATH             = /usr/bin
VBASIM             = /usr/bin/open
FIND               = find
COPY               = cp -r
